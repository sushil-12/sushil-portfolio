      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-lg shadow-2xl max-w-4xl w-full max-h-[95vh] sm:max-h-[85vh] overflow-hidden border border-neutral-200"
          >
            {/* Header */}
            <div className="sticky top-0 bg-black border-b border-neutral-700 px-3 sm:px-6 py-3 z-10">
              <div className="flex items-start justify-between mb-2 gap-3">
                <div className="flex-1 min-w-0">
                  <h2 className="text-base sm:text-lg font-bold text-white mb-1 truncate">{caseStudy.title}</h2>
                  <p className="text-neutral-300 text-xs line-clamp-2">{caseStudy.tagline}</p>
                </div>
                <div className="flex items-center gap-2 flex-shrink-0">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-2 sm:px-3 py-1.5 bg-white text-black text-xs font-semibold rounded hover:bg-neutral-100 transition-all duration-200 cursor-pointer"
                  >
            ...
            {/* Content */}
            <div className="overflow-y-auto max-h-[calc(95vh-80px)] sm:max-h-[calc(85vh-80px)] custom-scrollbar">
              {/* Hero Image */}
              ...
              <div className="px-3 sm:px-6 py-4 space-y-4 sm:space-y-6">
                ...
                <section>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 mb-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:gap-6 px-2 sm:px-4 py-2">
                      <div className="flex items-center gap-2">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 pl-3">
                    {caseStudy.results.map((result, index) => (
                      <div key={index} className="text-center p-2 sm:p-3 bg-black text-white rounded">
                        <div className="text-sm sm:text-lg font-bold">{result.value}</div>
              ...
              {/* Footer */}
              <div className="px-3 sm:px-6 py-4 bg-neutral-50 border-t border-neutral-200">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-1.5 px-4 py-2 border border-neutral-300 text-neutral-700 text-sm font-medium rounded hover:bg-white hover:border-neutral-400 transition-all duration-200"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-black text-white text-sm font-semibold rounded hover:bg-neutral-800 transition-all duration-200 shadow-sm"
                    >
